...
public class AccountConstants {
	...
	public static final String CALL_PRIZE_PATH = "";
	public static final String GET_PRIZE_PATH = "";
	public static final String CALL_ACCOUNT_NUMBER_PATH = "";
	public static final String GET_ACCOUNT_NUMBER_PATH = "";
